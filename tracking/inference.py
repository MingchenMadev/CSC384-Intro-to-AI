    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for oldPos in self.legalPositions:
            ...
            for p in self.legalPositions:
                allPossible[p] += (self.beliefs[oldPos] * newPostDist[p])
...
class ParticleFilter(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance == None:
            ...
            allPossible = util.Counter()
            w = [emissionModel[util.manhattanDistance(pacmanPosition, p)] for p in self.particles]
            for i, particle in enumerate(self.particles):
                allPossible[particle] += w[i]
        ...
        for _ , particle in enumerate(self.particles):
            ...
            for i in range(self.numGhosts):
                if noisyDistances[i] == None:
                    ...
                    p *= emissionModel[util.manhattanDistance(pacmanPosition, particle[i])]
